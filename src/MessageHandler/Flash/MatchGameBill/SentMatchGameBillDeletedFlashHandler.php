...
class SentMatchGameBillDeletedFlashHandler implements MessageHandlerInterface
{
    ...
    public function __invoke(MatchGameBillDeletedFlashMessage $message)
    {
        ...
        $this->manager->sendDeleted($matchGameBill);
    }
}
