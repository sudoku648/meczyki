...
class SentUserBoundWithPersonFlashHandler implements MessageHandlerInterface
{
    ...
    public function __invoke(UserBoundWithPersonFlashMessage $message)
    {
        ...
        $this->manager->sendPersonIsBound($user);
    }
}
