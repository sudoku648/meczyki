...
class SentUserDeactivatedFlashHandler implements MessageHandlerInterface
{
    ...
    public function __invoke(UserDeactivatedFlashMessage $message)
    {
        ...
        $this->manager->sendDeactivated($user);
    }
}
