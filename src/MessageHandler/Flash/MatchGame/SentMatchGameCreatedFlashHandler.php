...
class SentMatchGameCreatedFlashHandler implements MessageHandlerInterface
{
    ...
    public function __invoke(MatchGameCreatedFlashMessage $message)
    {
        ...
        $this->manager->sendCreated($matchGame);
    }
}
