...
class SentPersonUpdatedFlashHandler implements MessageHandlerInterface
{
    ...
    public function __invoke(PersonUpdatedFlashMessage $message)
    {
        ...
        $this->manager->sendUpdated($person);
    }
}
