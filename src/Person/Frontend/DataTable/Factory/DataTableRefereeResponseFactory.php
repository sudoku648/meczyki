...
use Sudoku648\Meczyki\Person\Frontend\DataTable\Model\DataTableRefereeRow;
...
readonly class DataTableRefereeResponseFactory extends DataTablePersonResponseFactory
{
    public function fromCriteria(Criteria $criteria): array
    {
        ...
        return array_map(
            function (int $objKey, Person $person) use ($criteria) {
                return new DataTableRefereeRow(
